    ...
    >
      <q-tr slot="body" slot-scope="props" :props="props">
        ...
        <q-td key="name" :props="props">
          <router-link :to="`/products/${props.row.id}`">
...
export default {
  ...
  methods: {
    request ({ pagination }) {
      ...
      axios
        .get(
          `http://127.0.0.1:8000/api/products/list/${pagination.page}?rowsPerPage=${pagination.rowsPerPage}&sortBy=${pagination.sortBy}&descending=${pagination.descending}`
        )
        .then(({ data }) => {
